...
<body style="margin:0;height: 100%;outline: none;color: #042A38 !important;">
    <div class="bg" style="font-weight: bolder;background-image: url(./images/reset1.jpg);background-repeat: no-repeat;padding: 0;margin: 0;background-size: cover;font-family: 'Courier New', Courier, monospace;opacity: 0.9;height: auto;padding-bottom: 5vw;">
        <center>
        ...
        if ($password === $cpassword) {
            ...
            if ($res == true) {
                ...
                if ($dbmail === $username) {
                    ...
                    $mail->addReplyTo('osesvit@gmail.com');
                    $mail->isHTML(true);
