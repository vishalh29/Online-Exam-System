            ...
            <section id="ans">
                <center>
                    <form style="margin: 0vw;width: 100vw" method="post">
                        ...
                        <input type="submit" name="submit1" value="Done" style="align=center; height: 3vw;width: auto;font-family: 'Courier New', Courier, monospace;font-weight: bolder;border-radius: 10px;border: 2px solid black;background-color: lightblue;">
                    </form>
                </center>
            </section>
        </section>
